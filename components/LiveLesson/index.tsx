...
import { PrivateLessonSchedule } from "@/types/schedule";

const LiveLessonForm = () => {
  const [formData, setFormData] = useState<PrivateLessonSchedule>({
    full_name: "",
    email: "",
    phone_number: "",
    message: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axiosInstance.post("/private-lesson-schedules", formData);
