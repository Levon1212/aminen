 ...
 * (rounder corners, warm tint) so it reads as the children's area.
 */
const KidsSection = ({
  content,
  articles,
      ...
      <div className="grid grid-cols-1 gap-7 sm:grid-cols-2 lg:grid-cols-3">
        {articles.map((article) => (
          <Link
            ...
            className="group flex flex-col overflow-hidden rounded-3xl border border-titlebg2 bg-titlebg2/30 shadow-solid-11 transition duration-200 hover:-translate-y-1 hover:shadow-solid-9"
          >
            <div className="relative aspect-16/10 w-full overflow-hidden bg-titlebg2/60">
              {article.thumbnail ? (
                <Image
